...
class TestScramblerFunctions(unittest.TestCase):
    ...
    def test_random_map_list_builder_no_filter(self):
        ...
        maps = {}
        random_map_list = {}
        maps_expected = {'Map 1': 'dmap_1', 'Map 2': 'smap_2', 'map 3': 'sMap_3', 'vmap1': 'vmap1', 'pmap 1': 'pmap_1', 'pmap 2': 'pmap_2'}
        scrambler.random_map_list_builder('', map_file, maps, random_map_list, MAP_LIST_SIZE)
    ...
    def test_random_map_list_builder_filters(self):
        ...
        self.assertEqual(len(maps), max(list(random_map_list.keys())) + 1)
        for e in filter:
            self.assertNotIn(e, random_map_list)